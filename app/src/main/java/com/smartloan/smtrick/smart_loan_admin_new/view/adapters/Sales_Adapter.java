...
public class Sales_Adapter extends RecyclerView.Adapter<Sales_Adapter.ViewHolder> {
    ...
    public Sales_Adapter(Context context, List<User> userArrayList, boolean isFromRequest) {
    ...
    public Sales_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Sales_Adapter.ViewHolder viewHolder = new ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final Sales_Adapter.ViewHolder holder, int position) {
